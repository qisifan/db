(function () {
	...
	* Description
	*/
	var doubanApp = angular.module('doubanApp', ['ngRoute','doubanApp.listModule','detailedModel','dirctiveModel']);

	doubanApp.config(['$routeProvider',function($routeProvider) {
		$routeProvider.
			when('/subject/:page',{
				templateUrl:'list/detailed.html',
	...
	//doubanApp.directive('serach',['$routeParams','$route','$timeout','$location',
